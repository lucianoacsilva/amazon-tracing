...
describe('PositionContract-amazon-tracing@0.0.3', () => {
    ...
    describe('createPosition', () => {
        it('should submit createPosition transaction', async () => {
            // TODO: populate transaction parameters
            const positionId: string = 'EXAMPLE4';
            const specimenId: string = 'EXAMPLE';
            const latitude: number = 0;
            const longitude: number = 0;
            const timestamp: string = 'EXAMPLE';
            const args: string[] = [positionId, specimenId, latitude.toString(), longitude.toString(), timestamp];
    ...
    describe('updatePosition', () => {
        it('should submit updatePosition transaction', async () => {
            // TODO: populate transaction parameters
            const positionId: string = 'EXAMPLE4';
            const latitude: number = -0.07;
            const longitude: number = -27.72;
            const timestamp: string = '15/05/2020:18:34:46';
    ...
    describe('getHistoryOfAsset', () => {
        it('should submit getHistoryOfAsset transaction', async () => {
            // TODO: populate transaction parameters
            const key: string = 'EXAMPLE4';
            const args: string[] = [key];

            const response: Buffer = await SmartContractUtil.submitTransaction('PositionContract', 'getHistoryOfAsset', args, gateway);
            // submitTransaction returns buffer of transcation return value
            // TODO: Update with return value of transaction
            console.log(JSON.parse(response.toString()));
            assert.equal(true, true);
    ...
    describe('readAllAssets', () => {
        it('should submit readAllAssets transaction', async () => {
            // TODO: Update with parameters of transaction
            const args: string[] = [];

            const response: Buffer = await SmartContractUtil.submitTransaction('PositionContract', 'readAllAssets', args, gateway);
            // submitTransaction returns buffer of transcation return value
            // TODO: Update with return value of transaction
            console.log(JSON.parse(response.toString()));
            assert.equal(true, true);
